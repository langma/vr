...
function takeOffBraces(list) {
  if (typeof(list[0]) == 'string' && typeof(list) != 'string') {
    return list[0];
  } else {
    return list;
  }
...
function cleanupInfo(info) {
  ...
  var reasonCode = info.reasonCode;
...
module.exports.getStationInfo = function (stationcode, cb) {
  request('http://188.117.35.14/TrainRSS/TrainService.svc/stationInfo?station='+encodeURIComponent(stationcode), function (error, response, body) {
